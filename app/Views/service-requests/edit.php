...
$errors = $errors ?? [];
?>
<form class="form-grid" method="post" action="/service-requests/<?= (int) $serviceRequest['id'] ?>" novalidate>
    <?php if ($errors): ?>
    ...
    <div class="sticky-actions">
        <a class="secondary-action" href="/service-requests/<?= (int) $serviceRequest['id'] ?>">Cancel</a>
